...
| [`zero-bloat-icon-favicon-skill`](skills/zero-bloat-icon-favicon-skill/SKILL.md) | Dual-standard favicon, touch icon, and web asset generator: Cupertino Crystal Glass (`skill.megapass.web.id`) and Minimalist Flat (`pastree.megapass.web.id`), 10 Lucide scale-2 presets, highlight bevel, C-native slicing 11 assets (ICO 16/32/48/64, Retina 48/96, Apple 180, PWA 192/512), bit-for-bit self-test, zero Node.js. | `favicon`, `icon`, `touch icon`, `app icon`, `generate gambar icon`, `webmanifest` |
